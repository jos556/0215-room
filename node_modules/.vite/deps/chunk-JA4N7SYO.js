...
var ThisVariable = class extends LocalVariable {
  ...
  hasEffectsOnInteractionAtPath(path2, interaction, context) {
    ...
    if (replacedVariableInit) {
      return replacedVariableInit.hasEffectsOnInteractionAtPath(path2, interaction, context) || // If the surrounding function is included, all mutations of "this" must
      // be counted as side effects, which is what this second line does.
      !context.ignore.this && super.hasEffectsOnInteractionAtPath(path2, interaction, context);
    }
    return UNKNOWN_EXPRESSION.hasEffectsOnInteractionAtPath(path2, interaction, context);
  }
};
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-ZOO26ZCD.js");
...
rollup/dist/es/shared/node-entry.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-JA4N7SYO.js.map
